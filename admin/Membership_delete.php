...
$result = mysql_query("select * from Join_Membership where num = $num", $conn);
...
<H1><center> 회원 삭제 </center></H1>

<?
echo("<center>
<FORM NAME='customer_info' ACTION='Membership_deletes.php' METHOD='post'>
        <input type=hidden name='num' value=$rec[num]>
		<input type=hidden name='id' value=$rec[id]>
  <TABLE border=1 cellpadding=0 cellspacing=0 width=300>
   <TR>
    <TD align='center' WIDTH='80'>ID</TD>    <TD> $rec[id] </TD>
  </TR>  <TR>
    <TD align='center'>성    명</TD>    <TD> $rec[name]</TD>
  </TR>   <TR>
    <TD align='center' WIDTH='80'>비밀번호 확인</TD>   <TD><INPUT TYPE='password' name= 'inpswd' SIZE='20'></TD>
  </TR>  <TR>
