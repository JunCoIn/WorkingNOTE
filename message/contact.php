...
<div class="main_display">
  ...
  <button class="click_back_button" onclick="move_message('<?php echo $id; ?>')"><img src="./../icon/message_icon_wh.jpg"></button>
  </div> <!-- main1 2 display -->
  ...
  <font class="menu_text" size=5 color=#FFFFFF><b>MESSAGE</b></font>
  <div class="main2_1_line"></div>
  </div> <!-- main2 1 display -->
  <div class="main2_2_display">
  <button class="click_side_button" onclick="move_message('<?php echo $id; ?>')">
