...
<div class="main_display">
  ...
  <button class="click_back_button" onclick="view_samu_list()"><img src="./../icon/samu_icon_wh.jpg"></button>
  ...
  <font class="menu_text" size=5 color=#FFFFFF><b>
  <?
  ...
  <button class="click_side_button" onclick="move_schedule_view()">
  &nbsp;&nbsp;&nbsp;<img src="./../icon/meeting_icon.jpg">&nbsp;&nbsp;
  <font size=4 color=black>업무</font>
  </button>
  <button class="side_button" onclick="move_schedule_view()">
  &nbsp;&nbsp;<img src="./../icon/schedule_icon.jpg">&nbsp;&nbsp;&nbsp;
  <font size=4 color=black>회사 일정</font>
  </button>
  <button class="side_button" onclick="move_schedule_view()">
  &nbsp;&nbsp;&nbsp;<img src="./../icon/file.jpg">&nbsp;&nbsp;&nbsp;
  <font size=4 color=black>자료실</font>
  </button>
  <button class="side_button" onclick="move_schedule_view()">
  &nbsp;&nbsp;&nbsp;<img src="./../icon/employee.jpg">&nbsp;&nbsp;&nbsp;
  <font size=4 color=black>직원</font>
  </button>
  </div> <!-- main2 2 display -->
