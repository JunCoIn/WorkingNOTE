...
<div class="main_display">
  ...
  <button class="logo_button" onclick="move_home('<?php echo $id; ?>')"><img src="./../icon/logo_wh.jpg"></button>
  ...
  <button class="click_back_button" onclick="move_schedule('<?php echo $id; ?>')"><img src="./../icon/schedule_icon_wh.jpg"></button>
  ...
  <font class="menu_text" size=5 color=#FFFFFF><b>SCHEDULE</b></font>
  <div class="main2_1_line"></div>
  </div> <!-- main2 1 display -->
  <div class="main2_2_display">
  <button class="click_side_button" onclick="move_schedule('<?php echo $id; ?>')">
  &nbsp;&nbsp;&nbsp;<img src="./../icon/schedule_icon.jpg">&nbsp;&nbsp;
  <font size=4 color=black>캘린더</font>
  </button>
  <button class="side_button" onclick="move_todolist('<?php echo $id; ?>')">
  &nbsp;&nbsp;&nbsp;<img src="./../icon/todo_icon.jpg">&nbsp;&nbsp;
  <font size=4 color=black>To do List</font>
  </button>
  <button class="side_button" onclick="move_memo('<?php echo $id; ?>')">
  &nbsp;&nbsp;&nbsp;<img src="./../icon/memo.jpg">&nbsp;&nbsp;&nbsp;
  <font size=4 color=black>메모</font>
  </button>
  </div> <!-- main2 2 display -->
...
function move_todolist(id) {
      var form = document.createElement('form');
      form.method = 'post';
      form.action = './../schedule/todolist.php';
...
function move_memo(id) {
      var form = document.createElement('form');
      form.method = 'post';
      form.action = './../schedule/memo.php';
